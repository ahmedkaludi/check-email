...
$reasons = array(
		...
		<li><input type="text" name="ck_mail_disable_text[]" value="" placeholder="' . __( 'Please describe the feature', 'check-email') . '"/></li>',
		...
		<li><input type="text" name="ck_mail_disable_text[]" value="" placeholder="' . __( 'Name of the plugin', 'check-email') . '"/></li>',
