        ...
        <div class="wrap">
            ...
            <div class="ck_dashboard-container">
                <div class="ck_dashboard-box">
                    ...
                    <p><?php echo esc_html__('To ensure that your email setup is correctly configured', 'check-email'); ?>
                ...
                <div class="ck_dashboard-box">
                    ...
                    <p><?php echo esc_html__('Email Spam Testing of your mail for accurate delivery', 'check-email'); ?>
                ...
                <div class="ck_dashboard-box">
                    ...
                    <p><?php echo esc_html__('An email list is a valuable asset for any business or organization', 'check-email'); ?>
                ...
                <div class="ck_dashboard-box">
                    ...
                    <p><?php echo esc_html__('Managing email errors is essential to ensure smooth communication and deliverability', 'check-email'); ?>
