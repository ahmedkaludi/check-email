<div id="checkemail" class="wrap">
    ...
    <form action="<?php echo esc_url( get_admin_url() ) . 'admin.php?page=check-email-status' ?>" method="post">
        <p>
            ...
            <input type="text" name="checkemail_to" id="checkemail_to" class="text" value="<?php echo (isset($_POST["checkemail_to"]) ? esc_attr( sanitize_email( $_POST["checkemail_to"] ) ) : '' ) ?>"/>
        </p>
        <p>
        ...
        <div id="customheaders" class="<?php echo ( !isset($_POST['checkemail_headers']) || $_POST['checkemail_headers'] == 'auto' ? 'checkemail-hide' : '' ) ?>"><br />
            ...
            <p>
                ...
                <input type="text" name="checkemail_mime" id="checkemail_mime" value="<?php echo (isset( $_POST['checkemail_mime'] ) ? esc_attr( sanitize_text_field( $_POST['checkemail_mime'] ) ) : '1.0') ?>"/>
            </p>
            <p>
                <label for="checkemail_type"><?php esc_html_e( 'Content type', 'check-email' ) ?></label>
                <input type="text" name="checkemail_type" id="checkemail_type" value="<?php echo ( isset( $_POST['checkemail_type'] ) ? esc_attr( sanitize_text_field( $_POST['checkemail_type'] ) ) : 'text/html; charset=iso-8859-1' ) ?>"/>
            </p>
            <p>
